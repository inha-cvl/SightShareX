...
export default {
  ...
  methods: {
    init3DScene() {
      ...
      const camera = new THREE.PerspectiveCamera(60, this.$refs.sceneContainer.clientWidth / this.$refs.sceneContainer.clientHeight, 0.1, 1000);
      ...
      object.position.set(0, 0, -10);  // 객체의 위치 설정
      scene.add(object);
